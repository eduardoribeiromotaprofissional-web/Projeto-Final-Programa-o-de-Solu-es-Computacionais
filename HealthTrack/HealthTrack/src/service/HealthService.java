...
public class HealthService {
    ...
    public void cadastrarBiometria(double peso) {
        ...
        try {
            ...
            String sql =
                    "INSERT INTO dado_biometrico(peso) VALUES (?)";
    ...
    public void atualizarBiometria(int id, double peso) {
        ...
        try {
            ...
            String sql =
                    "UPDATE dado_biometrico SET peso=? WHERE id=?";
